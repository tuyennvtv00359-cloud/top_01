    ...
    public void findByMa(int maNT) {
        ...
        try (Connection conn = DBConnection.getConnection(); CallableStatement cs = conn.prepareCall(sql)) {
            ...
            if (rs.next()) {
                ...
                System.out.printf("%-25s %35s%n","Cho thuê nhà ở tại:",dc1+" - "+quan);
                System.out.printf("%-25s %35s%n","Loại:",tl);
                System.out.printf("%-25s %35s%n","Diện tích:",dt+" m2");
                System.out.printf("%-25s %35s%n","Giá ở theo tháng:",gia+" VND");
                System.out.printf("%-25s %35s%n","Thời gian đăng cụ thể:",nd);
                System.out.printf("%-25s %35s%n","Mô tả:",mt);
                System.out.printf("%-25s %35s%n","Điểm đánh giá:",score+"/10  ("+like+" Like)");
                System.out.printf("--------------------------------------------------------------%n");
                System.out.printf("   -> Thông tin người liên hệ:%n");
                System.out.printf("%-25s %35s%n",tnd,"Giới tính: "+gt);
                System.out.printf("%-25s %35s%n","Phone: "+phone,"Email: "+email);
                System.out.printf("%-25s %35s%n","Địa chỉ liên hệ:",dc2+" - "+quan);
            } else {
